    ...
    def on_random_type_change(self, event=None):
        ...
        if gen_type == "string":
            ...
            ttk.Checkbutton(self.random_params_frame, text="包含数字", variable=self.string_numbers_var).grid(row=1,
                                                                                                              ...
                                                                                                              sticky=tk.W,
                                                                                                              pady=1)
            ttk.Checkbutton(self.random_params_frame, text="包含大写字母", variable=self.string_uppercase_var).grid(
                row=2,
                column=0,
                sticky=tk.W,
                pady=1)
            ttk.Checkbutton(self.random_params_frame, text="包含小写字母", variable=self.string_lowercase_var).grid(
                row=3,
                column=0,
                sticky=tk.W,
                pady=1)
            ...
            ttk.Checkbutton(self.random_params_frame, text="浮点数", variable=self.number_float_var).grid(row=2,
                                                                                                          column=0,
                                                                                                          sticky=tk.W,
                                                                                                          pady=1)
    ...
    def run_api_diff(self):
        try:
            ...
            if not old_text or not new_text:
                raise ValueError("请分别在“契约v1 / 契约v2”填入 JSON 文本或点击“ 从文件加载”")
